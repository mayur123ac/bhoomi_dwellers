        ...
        <div className="space-y-8">
          ...
          {user?.role?.toLowerCase() === "admin" && (
            <>
              <hr className="border-[#333]" />
              <div>
                <h3 className="text-sm font-bold mb-2">Billing & Quota Management</h3>
                <div className="bg-[#1a1a1a] p-4 rounded-lg border border-[#333] flex justify-between items-center">
                  <div>
                    <h4 className="text-white text-sm font-semibold">Subscription Plan</h4>
                    <p className="text-xs text-gray-400 mt-1">View usage, user limits, and plan details.</p>
                  </div>
                  <button 
